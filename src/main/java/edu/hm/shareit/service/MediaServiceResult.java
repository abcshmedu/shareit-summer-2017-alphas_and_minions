...
public enum MediaServiceResult {
	...
	OK(200), INVALID_ISBN(300), ISBN_RESERVED(301), MISSING_ISBN(302), ISBN_NOT_EQUAL(303),
	NO_BOOKS(304), INVALID_BARCODE(500), BARCODE_RESERVED(501), MISSING_BARCODE(502),
	BARCODE_NOT_EQUAL(503), NO_DISCS(504), MISSING_INFO(400),
	BAD_REQUEST(401), NOT_FOUND(404), IM_A_TEAPOT(418), MEDIUM_ALREADY_EXISTS(777);
	...
	public static String getErrorMessage(MediaServiceResult error) {
		...
		case OK:
			...
			break;
		case INVALID_ISBN:
			message = "Isbn is not valid. Please check "
					+ "the security digit.";
			break;
		case ISBN_RESERVED:
		...
		case NO_DISCS:
			...
			break;
		case MISSING_INFO:
			message = "Medium is missing information. "
					+ "Please check title and author or "
					+ "director are given.";
			break;
		case BAD_REQUEST:
			message = "Bad request. Could not be processed. "
					+ "Please check REST api.";
			break;
		case NOT_FOUND:
			message = "Not Found";
			break;
